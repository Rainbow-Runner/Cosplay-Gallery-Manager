...
export interface ManageLibraryAutomationPolicy { libraryID: number; mode: "MANUAL" | "ASSISTED" | "TRUSTED"; defaultContentRating?: "NON_ADULT" | "ADULT" | null; excludeNewRootMedia: boolean; autoAcceptUniqueEntities: boolean; autoAcceptMediaClassification: boolean; autoActivate: boolean; revision: number }
