...
import { ADD_COSER_SOCIAL_ACCOUNT, CREATE_CORE_ENTITY, MANAGE_CORE_ENTITIES, MANAGE_CORE_ENTITY, MANAGE_CORE_ENTITY_NAME_CONFLICTS, MANAGE_COSER_MANIFEST, MANAGE_COSER_NAME_CONFLICTS, PULL_COSER_MANIFEST, PUSH_COSER_MANIFEST, REPLACE_TAG_PARENTS, RESOLVE_COSER_MANIFEST, UPDATE_CORE_ENTITY } from "../api/manage";
...
function EntityForm({ draft, aliasText, setAliasText, aliasChips, setAliasChips, aliasChipDraft, setAliasChipDraft, setDraft, submit, saving, valid, nameReview }: { draft: ManageCoreEntity; aliasText: string; setAliasText: (value: string) => void; aliasChips: string[]; setAliasChips: (value: string[]) => void; aliasChipDraft: string; setAliasChipDraft: (value: string) => void; setDraft: (value: ManageCoreEntity) => void; submit: (event: FormEvent) => void; saving: boolean; valid: boolean; nameReview?: ReactNode }) {
