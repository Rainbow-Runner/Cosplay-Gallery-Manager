...
export function ManageCoreEntitiesPage({ coserOnly = false }: { coserOnly?: boolean }) {
  ...
  const [draft, setDraft] = useState<ManageCoreEntity>(blank(kind)); const [aliasText, setAliasText] = useState(""); const [aliasChips, setAliasChips] = useState<string[]>([]); const [aliasChipDraft, setAliasChipDraft] = useState(""); const [message, setMessage] = useState(""); const [coserTab, setCoserTab] = useState("profile");
...
function EntityForm({ draft, aliasText, setAliasText, aliasChips, setAliasChips, aliasChipDraft, setAliasChipDraft, setDraft, submit, saving, valid, coserNameReview }: { draft: ManageCoreEntity; aliasText: string; setAliasText: (value: string) => void; aliasChips: string[]; setAliasChips: (value: string[]) => void; aliasChipDraft: string; setAliasChipDraft: (value: string) => void; setDraft: (value: ManageCoreEntity) => void; submit: (event: FormEvent) => void; saving: boolean; valid: boolean; coserNameReview?: ReactNode }) {
