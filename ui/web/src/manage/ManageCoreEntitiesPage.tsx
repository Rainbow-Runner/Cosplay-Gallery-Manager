...
export function ManageCoreEntitiesPage({ coserOnly = false }: { coserOnly?: boolean }) {
  ...
  const entityValid = draft.name.trim() !== "" && (draft.kind !== "CHARACTER" || Boolean(draft.workUUID)) && duplicateReady;
